...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 01, 2018 at 04:26 PM
...
INSERT INTO `siswa` (`Nim`, `Nama`, `Progdi`) VALUES
('15.01.53.0060', 'ad', ''),
('15.01.53.0060', 'Adri Triandhika', 'Teknik Informatika'),
('15.01.53.0060', 'adri', 'TI');
...
--
ALTER TABLE `tbl_kategori`
  MODIFY `id_kategori_buku` int(11) NOT NULL AUTO_INCREMENT;
